...
<div class="col-sm-5m-8">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form class="form-horizontal"  enctype="multipart/form-data" method="POST" action="<?php echo URL::to("/pembeli/addProses"); ?>">
                <div class="form-group">
                    <label class="col-sm-3 control-label">Kode Pembeli</label>
                    <div class="col-sm-3">
                        <input type="text" name="id" class="form-control " placeholder="Kode Pembeli">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="jeniskelamin" class="form-control " placeholder="LAKI-LAKI / PEREMPUAN">
