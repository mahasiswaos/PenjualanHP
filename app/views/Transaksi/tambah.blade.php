...
<div class="col-sm-5m-8">
    <div class="panel panel-info">
        <div class="panel-heading"><i class="glyphicon glyphicon-circle-arrow-right"></i> Tambah Data Transaksi </div> 
        <div class="panel-body">
            <form class="form-horizontal"  enctype="multipart/form-data" method="POST" action="<?php echo URL::to("/transaksi/tambahProses"); ?>">
                <div class="form-group">
                    <label class="col-sm-3 control-label">KODE TRANSAKSI</label>
                    <div class="col-sm-3">
                        <input type="text" name="id" class="form-control " placeholder="KODE TRANSAKSI">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="kode_hp" class="form-control " placeholder="KODE HP">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="kode_pembeli" class="form-control " placeholder="KODE PEMBELI">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="totalbayar" class="form-control" placeholder="TOTAL BAYAR">
